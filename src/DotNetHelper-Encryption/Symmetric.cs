...
namespace DotNetHelper_Encryption
{
    ...
    public static class SymmetricFactory
    {
        ...
        public static SymmetricAlgorithm Create(SymmetricProvider provider, CipherMode cipherMode = CipherMode.ECB, PaddingMode padding = PaddingMode.PKCS7 )
        {
            ...
            if (algorithm == null) throw new NullReferenceException(nameof(provider) + provider);
    ...
    public class Symmetric : IDisposable
    {
        ...
        public Hash.PreEncryptData Encrypt(Hash.PreEncryptData d, SymmetricKeyData key)
        {
            Key = key;
            return Encrypt(d);
        }
        ...
        /// </summary>
        /// <exception cref="T:System.ArgumentNullException">data is null.</exception>
        public Hash.PreEncryptData Encrypt(Hash.PreEncryptData data)
        {
            ...
            using (var ms = new MemoryStream())
            {
                ...
                return new Hash.PreEncryptData(ms.ToArray());
            }
        }
        ...
        public Hash.PreEncryptData Encrypt(Stream stream, SymmetricKeyData key, SymmetricKeyData iv)
        {
        ...
        /// </summary>
        /// <exception cref="T:System.ArgumentNullException">stream is null.</exception>
        public Hash.PreEncryptData Encrypt(Stream stream, SymmetricKeyData key)
        {
            Key = key;
            return Encrypt(stream);
        }
        ...
        /// </summary>
        /// <exception cref="T:System.ArgumentNullException">stream is null.</exception>
        public Hash.PreEncryptData Encrypt(Stream stream)
        {
            ...
            using (var ms = new MemoryStream())
            {
                using (var cs = new CryptoStream(ms, _crypto.CreateEncryptor(), CryptoStreamMode.Write))
                {
                    ...
                    var i = stream.Read(b, 0, BufferSize);
                    while (i > 0)
                    {
                        cs.Write(b, 0, i);
        ...
        /// </summary>
        /// <exception cref="T:System.ArgumentNullException">stream is null.</exception>
        public Hash.PreEncryptData Decrypt(Stream stream, SymmetricKeyData key)
        {
            Key = key;
        ...
        /// </summary>
        /// <exception cref="T:System.ArgumentNullException">stream is null.</exception>
        public Hash.PreEncryptData Decrypt(Stream stream)
        {
            if (stream == null) throw new ArgumentNullException(nameof(stream));
        ...
        public Hash.PreEncryptData Decrypt(Hash.PreEncryptData data, SymmetricKeyData key)
        {
            Key = key;
            return Decrypt(data);
        }
        ...
        /// <exception cref="T:System.ArgumentNullException">data is null.</exception>
        /// <exception cref="T:System.Security.Cryptography.CryptographicException">Unable to decrypt data.</exception>
        public Hash.PreEncryptData Decrypt(Hash.PreEncryptData data)
        {
            if (data == null) throw new ArgumentNullException(nameof(data));
            ValidateKeyAndIv(false);
            ...
            using (var ms = new MemoryStream(data.Bytes, 0, data.Bytes.Length))
            {
                ...
                return new Hash.PreEncryptData(b);
            }
        }
    ...
    /// </summary>
    public class SymmetricKeyData : Hash.PreEncryptData
    {
        /// <inheritdoc />
        /// <summary>
